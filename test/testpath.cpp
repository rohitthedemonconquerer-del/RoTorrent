...
private slots:
    ...
    void testIterator() const
    {
        ...
        {
            const Path path {u"/usr/bin/rotorrent"_s};
            ...
            ++iter;
            QCOMPARE(*iter, Path(u"/usr/bin/rotorrent"_s));
        ...
        {
            const Path path {u"some/path/rotorrent"_s};
            ...
            ++iter;
            QCOMPARE(*iter, Path(u"some/path/rotorrent"_s));
...
#ifdef Q_OS_WIN
        {
            const Path path {u"C:\\RoTorrent\\rotorrent.exe"_s};
            ...
            ++iter;
            QCOMPARE(*iter, Path(u"C:\\RoTorrent"_s));

            ++iter;
            QCOMPARE(*iter, Path(u"C:\\RoTorrent\\rotorrent.exe"_s));
